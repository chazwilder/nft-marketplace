        ...
        <div className="mt-16">
          ...
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center">
                ...
                <div className="my-12 w-full flex justify-center">
                  <Image src={images.upload} width={100} height={100} alt="File Upload" style={{ objectFit: 'contain' }} className={theme === 'light' ? 'filter invert' : undefined} />
                </div>
            ...
            {fileUrl && (
              <aside>
                <div>
                  <img src={fileUrl} alt="file_upload_asset" />
                </div>
              </aside>
            )}
          </div>
