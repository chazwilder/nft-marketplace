...
const FooterLinks = ({ heading, items }) => (
  <div>
    <h3 className="dark:text-white text-nft-black-1 font-semibold text-xl mb-10 font-poppins">{heading}</h3>
    {items.map((item, index) => (
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal cursor-pointer text-base my-3 dark:hover:text-nft-gray-1 hover:text-nft-black-1" key={index}>{item}</p>
    ))}
  </div>
);
    ...
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      ...
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:px-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base">CryptoKet, Inc. All Rights Reserverd.</p>
